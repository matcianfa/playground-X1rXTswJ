...
valeurs_a_tester=[[14],[15],[16],[17],[18],[30],[50],[80]]
...
def test():
    try:
        for valeur in valeurs_a_tester:
            ...
            send_msg("Tests validés","Pour une personne de  {} ans, la FCM est bien de {}".format(",".join([str(val) for val in valeur]),str(rep)))
