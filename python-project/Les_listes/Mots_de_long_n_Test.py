...
valeurs_a_tester=[(5,["Cosinus","Sinus","Mathématiques", "Info", "Python", "Tests", "Angle", "Produit scalaire", "Polynome","Carré", "Losange", "Isocele", "Rectangle","Equilateral","Alterne interne", "Cercle","Aire","Perimètre", "Disque","Cone","Cube","Parallèle","Orthogonale", "Dodécaèdre","Icosaèdre","Tetraèdre","Fractale"]),(7,["Cosinus","Sinus","Mathématiques", "Info", "Python", "Tests", "Angle", "Produit scalaire", "Polynome","Carré", "Losange", "Isocele", "Rectangle","Equilateral","Alterne interne", "Cercle","Aire","Perimètre", "Disque","Cone","Cube","Parallèle","Orthogonale", "Dodécaèdre","Icosaèdre","Tetraèdre","Fractale"]),(4,["Cosinus","Sinus","Mathématiques", "Info", "Python", "Tests", "Angle", "Produit scalaire", "Polynome","Carré", "Losange", "Isocele", "Rectangle","Equilateral","Alterne interne", "Cercle","Aire","Perimètre", "Disque","Cone","Cube","Parallèle","Orthogonale", "Dodécaèdre","Icosaèdre","Tetraèdre","Fractale"]),(2,["Cosinus","Sinus","Mathématiques", "Info", "Python", "Tests", "Angle", "Produit scalaire", "Polynome","Carré", "Losange", "Isocele", "Rectangle","Equilateral","Alterne interne", "Cercle","Aire","Perimètre", "Disque","Cone","Cube","Parallèle","Orthogonale", "Dodécaèdre","Icosaèdre","Tetraèdre","Fractale"])]
