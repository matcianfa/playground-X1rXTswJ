...
valeurs_a_tester=[(3,4,5),(3,5,4),(2,2,3),(2,3,2),(2,2,2),(2,3,4),(1,1,1.4142135623730951),(1.4142135623730951,2,1.4142135623730951),(1.618033988749895,1.618033988749895,1),(1.618033988749895,1,1.618033988749895)]
...
def test():
    try:
        for valeur in valeurs_a_tester:
            rep=f(*valeur)
            sol=f_sol(*valeur)
            assert str(rep) == str(sol) or (str(rep)=="ISOCELE" and str(rep)=="TRIANGLE D'OR"), "En testant les valeurs {} le résultat obtenu est {} au lieu de {}".format(",".join([str(val) for val in valeur]),str(rep),str(sol))
