# Commençons par déterminer jusqu'à quelle valeur de n il faut chercher. en effet, pour former un nombre de n chiffres, il faut valoir moin de 10^n donc quand on cherche une puissance n-ieme, il suffit de chercher pour les nombres de 2 à 9.
