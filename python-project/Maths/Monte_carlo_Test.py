...
def test():
    try:
      for inp,outp,txt in input_output:
        ...
        assert abs(count1-outp)<0.05, "En testant les valeurs f(x)={}, a={} et b={} le résultat obtenu est {} au lieu de {}".format(str(txt),str(inp[1]),str(inp[2]),str(count1),str(outp))
