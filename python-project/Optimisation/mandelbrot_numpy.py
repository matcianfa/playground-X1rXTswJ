...
def mandelbrot(c):
    ...
    pas_fini =  resultats == 0 # Un tableau pour savoir pour quels indices il y a encore des calculs à faire. Initialisation à True sauf pour les c qui sont dans la cardioide ou le cercle.
