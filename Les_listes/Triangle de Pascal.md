...
@[Triangle de Sierpinski]({"stubs": ["Les_listes/Triangle_de_Sierpinski.py"], "command": "sh -c 'python3 Les_listes/Triangle_de_Sierpinski.py && echo "TECHIO> open -s /project/target/ index.html"'"})
