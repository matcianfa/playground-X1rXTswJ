...
@[Triangle de Sierpinski]({"stubs": ["Les_listes/Triangle_de_Sierpinski.py"], "command":  'python3 Les_listes/Triangle_de_Sierpinski.py && echo "TECHIO> open -s python-project/index.html"'})
